	...
	{	
		...
		switch (EXTPOTENTIAL) 
		{
			...
			{	
				...
				//halo
				const double vh=0*(131.5*131.5*2*1e10)/(All.UnitVelocity_in_cm_per_s*All.UnitVelocity_in_cm_per_s); //To take in account the used Gadget unity, in this cas the vel is vel^2.
